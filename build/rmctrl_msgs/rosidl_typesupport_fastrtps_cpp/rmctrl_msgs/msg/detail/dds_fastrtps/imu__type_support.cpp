...
#include "rmctrl_msgs/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmctrl_msgs::msg::Imu;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rmctrl_msgs::msg::Imu *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmctrl_msgs::msg::Imu *>(
    untyped_ros_message);
...
{
  return &rmctrl_msgs::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
